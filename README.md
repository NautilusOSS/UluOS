...
The gateway is also an MCP server. Agents connect once and get access to all 150 tools across 14 services — no need to configure individual MCP connections.
